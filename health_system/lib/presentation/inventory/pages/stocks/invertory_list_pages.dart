    ...
    child: Obx(() {
      return DropdownButtonHideUnderline(
        child: DropdownButton2(
          items: controller.center.map((String branch) {
          ...
          onChanged: (String? newValue) {
            if (newValue != null) {
              controller.selectedcenter.value = newValue;
            }
          },
          hint: Text(
            'Select Center',
                                      ...
                                      child: Row(
                                        children: [
                                          Container(
                                            ...
                                            color: Colors.grey.withOpacity(0.01),
                                            child: Center(
                                              child: Text(stocks.item_id, style: TextStyles.AppBartext),
                                            ),
                                          ),
                                          Container(
                                            width: 300,
                                            ...
                                            color: Colors.grey.withOpacity(0.01),
                                            child: Center(
                                              child: Text(stocks.item_name, style: TextStyles.AppBartext),
                                            ),
                                          ),
                                          Container(
                                            width: 200,
                                            ...
                                            color: Colors.grey.withOpacity(0.01),
                                            child: Center(
                                              child: Text(stocks.category, style: TextStyles.AppBartext),
                                            ),
                                          ),
                                          Container(
                                            width: 160,
                                            ...
                                            color: Colors.grey.withOpacity(0.01),
                                            child: Center(
                                              child: Text(stocks.quantity, style: TextStyles.AppBartext),
                                            ),
                                          ),
                                          Container(
                                            width: 100,
                                            ...
                                            color: Colors.grey.withOpacity(0.01),
                                            child: Center(
                                              child: Text(stocks.purchase_date, style: TextStyles.AppBartext),
                                            ),
                                          ),
                                          Container(
                                            width: 118,

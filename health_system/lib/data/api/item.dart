...
class Items {
  Future<ResponceModel> getitems() async {
    ...
    return data;
     ...
     Future<ResponceModel> updateitems(String item_id, String item_name, String item_type, String statuss,) async {
    final url = Uri.parse('${Config.apiUrl}${Config.updateitems}');
    final response = await http.post(url, body: {
      'item_id': item_id,
      'item_name': item_name,
      'item_type': item_type,
